...
class macro{
 ...
 ifstream ipFile("macro_input_2.txt",ios::in);
        string buffer,word;
        vector<string>temp;
        while(!ipFile.eof()){
            buffer="";
        ...
        ifstream MNTFile("MNTFile.txt",ios::in);
        ...
        ifstream MDTFile("MDTFile.txt",ios::in);
        ...
        ifstream PNTABFile("PNTABFile.txt",ios::in);
        temp={};
        ...
        ifstream KPTABFile("KPTABFile.txt",ios::in);
